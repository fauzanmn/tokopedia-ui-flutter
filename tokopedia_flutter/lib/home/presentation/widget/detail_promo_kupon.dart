...
class detailPromoKupon extends StatelessWidget {
  ...
  final String badgeToko;
  final String? namaKota;
  final String? rating;
  final String? terjual;
  final String stikerOngkir;
  final String? estimasi;
  const detailPromoKupon(this.imageLocation,
      {Key? key,
      this.namaBarang,
      this.cashback,
      required this.badgeToko,
      this.namaKota,
      this.rating,
      this.terjual,
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                Container(
                    width: 15, height: 15, child: SvgPicture.asset(badgeToko)),
                SizedBox(width: 3),
                Text(
                  "$namaKota",
